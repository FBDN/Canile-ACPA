...
include "header.php";
?>
<meta property="og:title" content="A.C.P.A Canile Comunale di Cesena I Nostri Ospiti">
<meta property="og:url" content="http://www.acpacesena.org/album.php">
...
include "script.php";
?>
<title>ACPA Canile Comunale di Cesena - I Nostri Ospiti -</title>
</head>
<body>
<script>
...
<script>
$(function(){
	$('.dogContainerWrapper').load("photos2.php",function(){
		$("#loader").hide();
		});
	})
