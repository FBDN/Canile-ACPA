...
$config = array(
    'app_id' => '839107256130056',
    'app_secret' => 'adf14965a22948e2a42632730b63faee',
);
...
try {
    $album = "349356188435427";
    $token = 'EAAL7KeHuGggBAFecE644xq2uGOg7TZCxGuurNpKWB1yfCxInHMStfzPPtVgQcpwJAznZB6NngDqHeUMZAAtTaJZAqoPqbaddJM2ZASRZCkkSgg9uCYcv2vaXE8oCXE3N7E4IumZCoH02NVE0uhBXSHjawagpsNhnjzLTsptyGmbRdNGVt3JtORIJw83kvzMaSxUgzpYiU6GYRnRAM9BbHQn';
...
?>
<div class="content col-md-12 border-left border-success text-dark">
<h1 class="text-dark"><?php echo ($albumName['name']=="Timeline Photos")?"FotoStoria":"";?></h1>
</div>
<?php 
...
<div class="imageResult col-sm-12 col-md-3 center-block">
						<img class="lazy center_cropped img-responsive img-thumbnail"  data-src="<?php echo $photo['images'][0]['source']?>">
					    <div class="caption">
