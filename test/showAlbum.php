...
?>
<div class="content col-md-12 border-left border-warning">
<h1 class="text-dark"><?php echo $albumName['name']?></h1>
</div>
<?php 
...
<?php }else{
?>
<!-- <div class="alert alert-warning"><h2>ALBUM INESISTENTE<h/2>></div> -->
<?php    
}
?>
